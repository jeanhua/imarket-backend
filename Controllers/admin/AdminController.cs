...
namespace imarket.Controllers.admin
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateCatogory([FromQuery][Required] string name, [FromQuery][Required] string description)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/CreateCategories", args);
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/CreateCategories", true);
        ...
        public async Task<IActionResult> EditCatogory([FromQuery][Required] ulong id, [FromQuery][Required] string name, [FromQuery][Required] string description)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/EditCategories", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/EditCategories", true);
            if (result_after!=null)
            {
                return Ok(result_after);
            }
        ...
        public async Task<IActionResult> DeleteCatogory([FromQuery][Required] ulong id)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/DeleteCategories", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/DeleteCategories", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        public async Task<IActionResult> GetUserList([FromQuery] int page=1, [FromQuery] int pageSize=10)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/ListUsers", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            var users = await userService.GetAllUsers(page, pageSize);
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/ListUsers", users);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        {
            var args = new object[] { id };
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/BanUser", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/BanUser", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        {
            var args = new object[] { id };
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/UnbanUser", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/UnbanUser", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        public async Task<IActionResult> CreateUser([FromBody][Required] UserCreateRequest user)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/CreateUser", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/CreateUser", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        public async Task<IActionResult> EditUser([FromBody][Required] UserEditRequest user)
        {
            ...
            var args = new object[] { user };
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/EditUser", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/EditUser", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        public async Task<IActionResult> DeleteUser([FromQuery][Required] ulong userId)
        {
            ...
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/DeleteUser", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/DeleteUser", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
        ...
        {
            var args = new object[] { userId };
            var result_before = await pluginManager.ExecuteBeforeAsync("api/Admin/DeletePosts", args);
            if (result_before != null)
            {
                return Ok(result_before);
            }
            ...
            var result_after = await pluginManager.ExecuteAfterAsync("api/Admin/DeletePosts", true);
            if (result_after != null)
            {
                return Ok(result_after);
            }
